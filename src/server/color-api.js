...
* `Router`...
*/
router.get('/colors', (req, res) => res.status(200).json(req.store.getState().colors))

router.post('/colors', (req, res) => dispatchAndRespond(req, res, {
    type: C.ADD_COLOR,
    id: v4(),
...
router.put('/color/:id', (req, res) => dispatchAndRespond(req, res, {
    type: C.RATE_COLOR,
    id: req.params.id,
    rating: parseInt(req.body.rating),
}))

router.delete('/color/:id', (req, res) => dispatchAndRespond(req, res, {
    type: C.REMOVE_COLOR,
    id: req.params.id,
}))
