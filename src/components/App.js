...
const App = (props) => {
    ...
    return (
    <div>
        {1==0?<pre>props.location.pathname={props.location.pathname}</pre>:''}
        ...
        {1==0?
         ...
         <hr/>
         <span style={linkStyle}><Link className={props.location.pathname == "/scrumi-react/objectives" ? "link-active" : ""} to="/scrumi-react/objectives">Objectives</Link></span><span style={linkStyle}><Link className={props.location.pathname == "/scrumi-react/users" ? "link-active" : ""} to="/scrumi-react/users">Users</Link></span>
         <hr/>
         </div>
         </div>
         </div>
