...
const sWhere = '__tests__/components/ui/SortButton.test.js'
...
describe('<SortButton /> UI Component', () => {
    ...
    describe('Rendering and clicking', () => {
        ...
        it('renders the correct glyph -- with class .glyphicon-chevron-up', () => expect(wrapper.find('.glyphicon-chevron-up').length)
            .toEqual(1))
    })

    describe('Clicking', () => {
        const sWho = `${sWhere}::Clicking...`
