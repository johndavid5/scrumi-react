...
import fetch from 'isomorphic-fetch' // Need to mock isomorphic-fetch for objectivesFilter() action creator...
...
describe('<ObjectivesListContainer /> Container ', () => {
    ...
    it('dispatches an OBJECTIVES_GET action', (done) => {
        ...
        const sWho = `${sWhere}: dispatches an OBJECTIVES_GET action`
        ...
        const faux_action = { "type": "OBJECTIVES_GET",
                'filters': {},
